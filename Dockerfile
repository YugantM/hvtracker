...
COPY .nojekyll robots.txt analytics.js og-v2.png og-verify.png og-provenance.png favicon.svg hex-bg.svg haystack-logo.png aipass-logo.png composio-logo.svg ./
