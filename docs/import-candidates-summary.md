# Import Candidates Summary
**Generated:** 2026-05-26  
**Universe file:** `docs/agent-universe-v1.json` (491 total entries)  
...
## New Candidates — Full List

| Name | Repo | Category | TC | Notes |
|---|---|---|---|---|
| AIlice | [myshell-ai/AIlice](https://github.com/myshell-ai/AIlice) | Agent Frameworks | D | Found via GitHub search — verify before import |
| Agency Swarm | [VRSEN/agency-swarm](https://github.com/VRSEN/agency-swarm) | Agent Frameworks | D/H | Known repo |
| Agent Hospital | [wisdom-pan/Agent_Hospital](https://github.com/wisdom-pan/Agent_Hospital) | Agent Frameworks | D | Found via GitHub search — verify before import |
| Agent Laboratory | [SamuelSchmidgall/AgentLaboratory](https://github.com/SamuelSchmidgall/AgentLaboratory) | Agent Frameworks | D | Found via GitHub search — verify before import |
| AgentBench agents | [THUDM/AgentBench](https://github.com/THUDM/AgentBench) | Agent Frameworks | D | Multi-environment agent evaluation benchmark |
| AgentLLM | [idosal/AgentLLM](https://github.com/idosal/AgentLLM) | Agent Frameworks | D | Found via GitHub search — verify before import |
| AgentLite | [SalesforceAIResearch/AgentLite](https://github.com/SalesforceAIResearch/AgentLite) | Agent Frameworks | D | Found via GitHub search — verify before import |
| AgentNeo | [AgentNEOTeam/agentneoteam.github.io](https://github.com/AgentNEOTeam/agentneoteam.github.io) | Agent Frameworks | D | Found via GitHub search — verify before import |
| Atomic Agents | [BrainBlend-AI/atomic-agents](https://github.com/BrainBlend-AI/atomic-agents) | Agent Frameworks | D | Known repo |
| Bee Agent Framework | [i-am-bee/bee-agent-framework](https://github.com/i-am-bee/bee-agent-framework) | Agent Frameworks | D | Known repo |
| Burr | [dagworks-inc/burr](https://github.com/dagworks-inc/burr) | Agent Frameworks | D | Workflow orchestration for AI agents |
| ControlFlow | [PrefectHQ/ControlFlow](https://github.com/PrefectHQ/ControlFlow) | Agent Frameworks | D | Known repo |
| CrewAI examples | [crewAIInc/crewAI-examples](https://github.com/crewAIInc/crewAI-examples) | Agent Frameworks | D/H | Found via GitHub search — verify before import |
| FastAgency | [ag2ai/fastagency](https://github.com/ag2ai/fastagency) | Agent Frameworks | D | Found via GitHub search — verify before import |
| Generative Agents | [joonspk-research/generative_agents](https://github.com/joonspk-research/generative_agents) | Agent Frameworks | D | Found via GitHub search — verify before import |
| Google Genkit | [firebase/genkit](https://github.com/firebase/genkit) | Agent Frameworks | D/H | Known repo |
| Griptape | [griptape-ai/griptape](https://github.com/griptape-ai/griptape) | Agent Frameworks | D/H | Known repo |
| JARVIS / HuggingGPT | [microsoft/JARVIS](https://github.com/microsoft/JARVIS) | Agent Frameworks | D | Microsoft JARVIS / HuggingGPT task planning agent |
| LangChain | [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | Agent Frameworks | D/H | Known repo |
| Langroid | [langroid/langroid](https://github.com/langroid/langroid) | Agent Frameworks | D | Known repo |
| LlamaIndex | [run-llama/llama_index](https://github.com/run-llama/llama_index) | Agent Frameworks | D/H | Known repo |
| Marvin | [PrefectHQ/marvin](https://github.com/PrefectHQ/marvin) | Agent Frameworks | D | Found via GitHub search — verify before import |
| Mastra | [mastra-ai/mastra](https://github.com/mastra-ai/mastra) | Agent Frameworks | D/H | Known repo |
| OpenAGI | [agiresearch/OpenAGI](https://github.com/agiresearch/OpenAGI) | Agent Frameworks | D | Found via GitHub search — verify before import |
| OpenAI Agents SDK | [openai/openai-agents-python](https://github.com/openai/openai-agents-python) | Agent Frameworks | D/H | Known repo |
| OpenAgents | [xlang-ai/OpenAgents](https://github.com/xlang-ai/OpenAgents) | Agent Frameworks | D | Found via GitHub search — verify before import |
| OpenManus | [FoundationAgents/OpenManus](https://github.com/FoundationAgents/OpenManus) | Agent Frameworks | D | Verify: FoundationAgents fork has 56k stars |
| OpenSSA | [aitomatic/openssa](https://github.com/aitomatic/openssa) | Agent Frameworks | D | Found via GitHub search — verify before import |
| Sotopia agents | [sotopia-lab/sotopia](https://github.com/sotopia-lab/sotopia) | Agent Frameworks | D | Social intelligence simulation framework |
| Swarm by OpenAI | [openai/swarm](https://github.com/openai/swarm) | Agent Frameworks | D | OpenAI experimental multi-agent framework |
| SwarmZero | [swarmzero/swarmzero](https://github.com/swarmzero/swarmzero) | Agent Frameworks | D/H | Found via GitHub search — verify before import |
| TaskWeaver | [microsoft/TaskWeaver](https://github.com/microsoft/TaskWeaver) | Agent Frameworks | D | Found via GitHub search — verify before import |
| TinyAgents | [albertvillanova/tinyagents](https://github.com/albertvillanova/tinyagents) | Agent Frameworks | D | Found via GitHub search — verify before import |
| TinyTroupe | [microsoft/TinyTroupe](https://github.com/microsoft/TinyTroupe) | Agent Frameworks | D | Found via GitHub search — verify before import |
| ToolLLM | [papablack/Docker-ToolLLM](https://github.com/papablack/Docker-ToolLLM) | Agent Frameworks | D | Found via GitHub search — verify before import |
| Voyager | [Nagi-ovo/gemini-voyager](https://github.com/Nagi-ovo/gemini-voyager) | Agent Frameworks | D | Found via GitHub search — verify before import |
| Voyager Minecraft Agent | [MineDojo/Voyager](https://github.com/MineDojo/Voyager) | Agent Frameworks | D | LLM-powered lifelong learning agent in Minecraft |
| WebArena agents | [web-arena-x/webarena](https://github.com/web-arena-x/webarena) | Agent Frameworks | D | Realistic web environment benchmark |
| XAgent | [OpenBMB/XAgent](https://github.com/OpenBMB/XAgent) | Agent Frameworks | D | Found via GitHub search — verify before import |
| smolagents | [huggingface/smolagents](https://github.com/huggingface/smolagents) | Agent Frameworks | D | Known repo |
| Agent-E | [EmergenceAI/agent-e](https://github.com/EmergenceAI/agent-e) | Browser & Computer Use | D | Browser automation agent |
| BrowserGym agents | [ServiceNow/BrowserGym](https://github.com/ServiceNow/BrowserGym) | Browser & Computer Use | D | Browser task gym — benchmark/env |
| Open Operator | [browserbase/open-operator](https://github.com/browserbase/open-operator) | Browser & Computer Use | D | Found via GitHub search — verify before import |
| OpenCUA | [xlang-ai/OpenCUA](https://github.com/xlang-ai/OpenCUA) | Browser & Computer Use | D | Found via GitHub search — verify before import |
| OpenClaw | [openclaw/openclaw](https://github.com/openclaw/openclaw) | Browser & Computer Use | D | Found via GitHub search — verify before import |
| Skyvern | [Skyvern-AI/skyvern](https://github.com/Skyvern-AI/skyvern) | Browser & Computer Use | D/H | Found via GitHub search — verify before import |
...
| opencode | [sst/opencode](https://github.com/sst/opencode) | Coding Agents | D | Open source coding agent (165k stars) |
...
| Agenta | [Agenta-AI/agenta](https://github.com/Agenta-AI/agenta) | Observability & Evaluation | D/H | Found via GitHub search — verify before import |
...
|---|---|---|---|
| Agent K | Agent Frameworks | D | Cannot identify a specific public repo |
| AutoGen Studio | Agent Frameworks | D | Sub-project of microsoft/autogen — not separately trackable |
| ChatArena agents | Agent Frameworks | D | Research simulation environment |
| LangGraph templates | Agent Frameworks | D/H | Examples repo — not a standalone agent |
| LlamaIndex agent examples | Agent Frameworks | D/H | Examples — not a standalone agent |
| MCP server examples | Agent Frameworks | D | Examples — not a standalone agent |
| Magentic-One | Agent Frameworks | D | No standalone public repo — part of microsoft/autogen monorepo |
| Mind2Web agents | Agent Frameworks | D | Research benchmark dataset |
| OpenBMB agents | Agent Frameworks | D | Generic grouping across multiple OpenBMB repos |
| Semantic Kernel samples | Agent Frameworks | D/H | GitHub search returned no confident match |
| ToolBench agents | Agent Frameworks | D | Benchmark dataset — not a standalone agent tool |
| Transformers Agents | Agent Frameworks | D | Sub-feature of huggingface/transformers — not separately trackable |
| WebShop agents | Agent Frameworks | D | Research benchmark environment |
...
| LangChain tools | Protocols & Tool Integration | D/H | Submodule of langchain — not separately trackable |
...
| RoboCasa agents | Robotics & Embodied | D | Research simulator — benchmark, not agent tool |
| Docker agent sandboxes | Sandboxes & Runtimes | D | Too generic — no single repo |
| Firecracker-based sandboxes | Sandboxes & Runtimes | D/H | Too generic — no single repo |
| Kubernetes agent runners | Sandboxes & Runtimes | D/H | Too generic — no single repo |
...
| Name | Repo | Category |
|---|---|---|
| Activepieces | [activepieces/activepieces](https://github.com/activepieces/activepieces) | Workflow Platforms |
| AgentScope | [agentscope-ai/agentscope](https://github.com/agentscope-ai/agentscope) | Agent Frameworks |
| AgentVerse | [OpenBMB/AgentVerse](https://github.com/OpenBMB/AgentVerse) | Agent Frameworks |
| Agno / Phidata | [agno-agi/agno](https://github.com/agno-agi/agno) | Agent Frameworks |
| AnythingLLM | [Mintplex-Labs/anything-llm](https://github.com/Mintplex-Labs/anything-llm) | Memory & Knowledge |
| AutoGPT | [Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) | Agent Frameworks |
| BabyAGI | [yoheinakajima/babyagi](https://github.com/yoheinakajima/babyagi) | Agent Frameworks |
| CAMEL-AI | [camel-ai/camel](https://github.com/camel-ai/camel) | Agent Frameworks |
| ChatDev | [OpenBMB/ChatDev](https://github.com/OpenBMB/ChatDev) | Agent Frameworks |
| Cline | [cline/cline](https://github.com/cline/cline) | Coding Agents |
...
| E2B | [e2b-dev/e2b](https://github.com/e2b-dev/e2b) | Sandboxes & Runtimes |
| Firecrawl | [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) | Research & Data |
| Flowise | [FlowiseAI/Flowise](https://github.com/FlowiseAI/Flowise) | Workflow Platforms |
| GPT Pilot | [Pythagora-io/gpt-pilot](https://github.com/Pythagora-io/gpt-pilot) | Coding Agents |
...
| Letta | [letta-ai/letta](https://github.com/letta-ai/letta) | Memory & Knowledge |
| LiveKit Agents | [livekit/agents](https://github.com/livekit/agents) | Voice & Conversational |
| MemGPT | [letta-ai/letta](https://github.com/letta-ai/letta) | Memory & Knowledge |
| MetaGPT | [geekan/MetaGPT](https://github.com/geekan/MetaGPT) | Agent Frameworks |
...
| Pydantic AI | [pydantic/pydantic-ai](https://github.com/pydantic/pydantic-ai) | Agent Frameworks |
| Qwen-Agent | [QwenLM/Qwen-Agent](https://github.com/QwenLM/Qwen-Agent) | Agent Frameworks |
| Roo Code | [RooVetGit/Roo-Code](https://github.com/RooVetGit/Roo-Code) | Coding Agents |
| SWE-agent | [princeton-nlp/SWE-agent](https://github.com/princeton-nlp/SWE-agent) | Coding Agents |
